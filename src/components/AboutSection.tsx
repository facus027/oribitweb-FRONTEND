...
export default function AboutSection() {
  return (
    <section
      ...
      style={{
        backgroundImage: `url('https://res.cloudinary.com/dwxwejuvu/image/upload/f_auto,q_auto,w_auto,dpr_auto,c_fill/zdogp2eek53b6nm4a48c.jpg')`, // reemplazá por tu imagen
