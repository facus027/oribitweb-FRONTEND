...
export default function Header() {
    return (
        <header className=' shadow-md flex opacity-90  fixed z-20 h-16 rounded-full w-full mx-auto justify-center  py-2'>
            <div className="flex justify-between items-center w-11/12 mx-auto">
                <div className="flex gap-5">
                    <div
                        onClick={() => scroll.scrollToTop({ duration: 500, smooth: "easeInOutQuad" })}
                    >
                        <img className="h-56 pt-2 items-center justify-center cursor-pointer hidden dark:block" src="logo.png" alt="logoOrbitWeb" />
                    </div>
                </div>
                <div className="flex">
                    <nav>
